package br.com.plopes;

import br.com.plopes.dao.ClientSetDAO;
import br.com.plopes.dao.IClienteDAO;
import br.com.plopes.domain.Cliente;
...
public class App {
    ...
    private static void consultar(String dados) {
        ...
        if (cliente != null) {
            JOptionPane.showMessageDialog(null, "Cliente encontrado com sucesso: " + cliente, "Sucesso",JOptionPane.INFORMATION_MESSAGE);
        } else {
